...
namespace COMP123_S2016_Lesson5
{
    ...
    public class Deck : List<Card>
    {
        ...
        /**
         * <summary>
         * This method will remove the 0th card from the deck and return it to the caller
         * </summary>
         * 
         * @method Deal
         * @returns {card}
        ...
        public Card Deal()
        {
            ...
            if (this.Count > 0)
            {
                this.RemoveAt(0);   //problem, if there is no cards to deal, or if the count reaches 0      
            }
